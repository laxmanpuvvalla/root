package git.admin.client.presenter.product;

import java.util.HashMap;

import git.admin.client.datasource.ShippingCountryListDataSourceFactory;
import git.admin.client.datasource.ShippingCountrySearchDataSourceFactory;
import git.admin.client.view.product.MyCompanyProductDisplay;
